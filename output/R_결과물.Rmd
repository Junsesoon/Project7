...
# 라이브러리 모음
install.packages("data.table", repos="http://cran.us.r-project.org") #copy()
install.packages('phonTools', repos="http://cran.us.r-project.org") #zeros()비교
install.packages('plyr', repos="http://cran.us.r-project.org") # empty함수를 쓰기 위한 패키지 설치
